 ...
 <section id="contact">
    ...
    <article>
        <p>Contact If You Have A Suggestion Or Problems </p>
        <label for="checkcontact" class="contactbutton"><div class="mail"></div></label><input id="checkcontact" type="checkbox">
        <form  action="ContactSupport/ContactDatabse.php" method="post" class="contactform">
            <p class="input_wrapper"><input type="text" required name="contact_nom" value=""  id ="contact_nom"><label for="contact_nom">NAME</label></p>
            <p class="input_wrapper"><input type="text" required name="contact_email" value=""  id ="contact_email"><label for="contact_email">EMAIL</label></p>
            <p class="input_wrapper"><input type="text" required name="contact_sujet" value=""  id ="contact_sujet"><label for="contact_sujet">SUBJECT</label></p>
            <p class="textarea_wrapper"><textarea required name="contact_message" id="contact_message"></textarea></p>
            <p class="submit_wrapper"><input type="submit" value="Send"></p>     
        </form>
    </article>
</section>

<style>@import url(https://fonts.googleapis.com/css?family=Oswald:400,700);
