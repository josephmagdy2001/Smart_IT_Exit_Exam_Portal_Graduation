    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar10">
            <ul class="navbar-nav nav-fill w-100" style="color:white">
                ...
                <li class="nav-item <?php echo (isset($_GET['SendFeedback'])?'active':'') ?>">
                    <a class="nav-link" href="?SendFeedback"><h6><i class="fa fa-user" aria-hidden="true"></i> Send Feedback</h6></a>
                </li>
                <li class="nav-item <?php echo (isset($_GET['display.php'])?'active':'') ?>">
                    <a class="nav-link" href="/online-exam-system-master/Community_Student/display.php"><h6><i class="fa fa-user" aria-hidden="true"></i> Share Recourses</h6></a>
                </li>
                <li class="nav-item">
