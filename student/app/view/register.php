...
<div class="login-html">
	...
	<div class="login-form">
		...
		<form class="siggn-in-htm" id="registerForm" action="app/controller/student.inc.php?action=register" method="post">
			...
			<input type="text" id="name" name="name" class="input input-holder" value="<?php echo $student->name ?>" >
			</div>-->
			<div class="group">
	...
	<?php }else{ ?>
		<form class="siggn-in-htm" id="checkIDForm" action="app/controller/student.inc.php?action=checkID" method="post">
			<div class="group">
			<label for="id" class="label">Student ID</label>
			<input type="text" name="id" class="input input-holder" minlength="7" title="Please Enter Your Real Student ID" placeholder="20*****"  required pattern="\b20\w[0-9]*">
			</div>
			<div class="group">
