...
<html lang="en">
<head>
    <title>Smart It Exit Exam Portal Documentation</title>
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <link rel="shortcut icon" href="instructor\favicon.ico" type="image/x-icon">
...
<body class="landing-page">
            ...
            <div class="container">
                <div class="branding">
                    <h1 class="logo">
                        ...
                        <span class="text-highlight">Smart It Exit Exam Portal</span> <span class="text-bold">DOCS</span>
                    </h1>
                </div>
                ...
                <div id="cards-wrapper" class="cards-wrapper row">
                    <div class="item item-purple col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <a class="link" href="student"><span></span></a>
                        </div>
                    </div>
                    <div class="item item-primary col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <a class="link" href="instructor"><span></span></a>
                        </div>
                    </div>
                    <div class="item item-orange col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <a class="link" href="admin"><span></span></a>
                        </div>
                    </div>
                </div>
    ...
    <footer class="footer text-center">
        <div class="container">
            <small class="copyright">&copy;CopyRights <?php   echo $current_time = date(' Y');
                ?>, <strong>Powered By Joseph Magdy</strong> All rights reserved for Faculty of EELU Hurghada </small>
