...
if (isset($_SESSION['mydata']) and !$_SESSION['mydata']->isAdmin and $inst->checkAccount($_SESSION['mydata']->id)) {
    ...
    } elseif (isset($_GET['feedback.php'])) {
        require_once ' \online-exam-system-master\student\app\view\feedback.php';
    } elseif (isset($_GET['ViewFeedbackAdmin.php'])) {
        require_once ' \online-exam-system-master\ContactSupport\ViewFeedbackAdmin.php';
