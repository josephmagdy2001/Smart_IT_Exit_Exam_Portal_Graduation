...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    3: function (t, e, n) {
      ...
      function N(t) {
        return (
          !T(t) && t && /^DIV|^P|^LI|^H[1-7]/.test(t.nodeName.toUpperCase())
        );
      }
      var P = $("PRE"),
        R = $("LI");
      ...
      function rt(t, e) {
        ...
        } else if (((n = t.node), (o = e ? W(t.node) : t.offset + 1), K(n)))
          return null;
        return { node: n, offset: o };
      }
      function at(t, e) {
      ...
      function st(t, e) {
        ...
        return (
          Z(a, G(r)),
          n || (q(t.node), q(a)),
          i && (K(t.node) && ut(t.node), K(a)) ? (ut(a), t.node.nextSibling) : a
        );
      }
      function lt(t, e, n) {
      ...
      var ft = {
        ...
        splitPoint: function (t, e) {
          ...
          var s =
            n &&
            lt(n, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
          return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t) {
                var e = this.modules[t];
                e.shouldInitialize() &&
                  (e.events && ft.detachEvents(this.$note, e.events),
                  e.destroy && e.destroy()),
      ...
      var kt = (function () {
            ...
            (n = [
                ...
                value: function () {
                  if (v.isW3CRangeSupport) {
                    ...
                    return (
                      t.setStart(
                        this.sc,
                        this.sc.data && this.so > this.sc.data.length
                          ? 0
                          : this.so
                      ),
                      t.setEnd(
                ...
                value: function () {
                  var e = function (t, e) {
                      ...
                      if (
                        ft.isVisiblePoint(t) &&
                        (!ft.isEdgePoint(t) ||
                          (ft.isRightEdgePoint(t) && !e) ||
                          (ft.isLeftEdgePoint(t) && e) ||
                          (ft.isRightEdgePoint(t) &&
                            e &&
                            ft.isVoid(t.node.nextSibling)) ||
                          (ft.isLeftEdgePoint(t) &&
                            !e &&
                            ft.isVoid(t.node.previousSibling)) ||
                          (ft.isBlock(t.node) && ft.isEmpty(t.node)))
                      )
                        return t;
                      ...
                      if (!o) {
                        ...
                        o =
                          (ft.isLeftEdgePointOf(t, n) || ft.isVoid(i.node)) &&
                          !e;
                      }
                      var r = !1;
                      if (!r) {
                        ...
                        r =
                          (ft.isRightEdgePointOf(t, n) || ft.isVoid(a.node)) &&
                          e;
                      }
                      if (o || r) {
                    ...
                    ft.walkPoint(
                      ...
                      function (e) {
                        ...
                        ft.isEditable(e.node) ||
                          (o
                            ? (ft.isLeftEdgePoint(e) && s.push(e.node),
                              ft.isRightEdgePoint(e) &&
                                x.contains(s, e.node) &&
                                (i = e.node))
                            : (i = n ? ft.ancestor(e.node, t) : e.node),
                          i && t(i) && a.push(i));
                      },
                      !0
                    ),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    ft.isText(this.ec) &&
                      !ft.isEdgePoint(this.getEndPoint()) &&
                      this.ec.splitText(this.eo),
                    ft.isText(this.sc) &&
                      !ft.isEdgePoint(this.getStartPoint()) &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (e) {
                    ...
                    if (
                      (i = i.concat(
                        ft.listNext(e.nextSibling, ft.isParaInline)
                      )).length
                    ) {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    e &&
                      (n = ft.nextPointUntil(n, function (t) {
                        return !ft.isCharPoint(t);
                      })),
              ...
              },
              {
                ...
                value: function (t) {
                  return {
                    s: { path: ft.makeOffsetPath(t, this.sc), offset: this.so },
                    e: { path: ft.makeOffsetPath(t, this.ec), offset: this.eo },
                  };
                },
              },
              {
        ...
        yt = {
          ...
          createFromNode: function (t) {
            ...
            return (
              ft.isVoid(e) &&
                ((n = ft.listPrev(e).length - 1), (e = e.parentNode)),
              ft.isBR(o)
                ? ((i = ft.listPrev(o).length - 1), (o = o.parentNode))
                : ft.isVoid(o) &&
                  ((i = ft.listPrev(o).length), (o = o.parentNode)),
              this.create(e, n, o, i)
            );
          },
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  (n.anchor = t.isOnAnchor() && ft.ancestor(t.sc, ft.isAnchor)),
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                if (x.find(r, ft.isPurePara)) {
                  ...
                  var c = o
                    .nodes(ft.isList, { includeAncestor: !0 })
                    .filter(function (e) {
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  ...
                  r &&
                    (ft.appendChildNodes(a, x.from(r.childNodes)),
                    ft.remove(r)),
                  t
                );
              },
                  ...
                  i.a.each(t, function (t, r) {
                    ...
                    if ("LI" === l.parentNode.nodeName)
                      ...
                      var u =
                        ...
                        d = ft.splitTree(
                          l,
                          { node: a.parentNode, offset: ft.position(a) },
                          { isSkipPaddingBlankHTML: !0 }
                        );
                      (r = e
                        ? ft.listDescendant(d, ft.isLi)
                        : x.from(d.childNodes).filter(ft.isLi)),
                        (!e && ft.isList(l.parentNode)) ||
                          (r = r.map(function (t) {
            ...
            },
            {
              ...
              value: function (t) {
                return t.previousSibling
                  ? ft.appendChildNodes(t.previousSibling, [t])
                  : this.wrapList([t], "LI");
              },
            },
            {
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t, e) {
                e = (e = (e =
                  e || yt.create(t)).deleteContents()).wrapBodyInlineWithPara();
                var n,
                  o = ft.ancestor(e.sc, ft.isPara);
                if (o) {
                  if (
                    ft.isLi(o) &&
                    (ft.isEmpty(o) || ft.deepestChildIsEmpty(o))
                  )
                    return void this.bullet.toggleList(o.parentNode.nodeName);
                  var r = null;
                  if (
                    (1 === this.options.blockquoteBreakingLevel
                      ? (r = ft.ancestor(o, ft.isBlockquote))
                      : 2 === this.options.blockquoteBreakingLevel &&
                        (r = ft.lastAncestor(o, ft.isBlockquote)),
                    r)
                  ) {
                    (n = i()(ft.emptyPara)[0]),
                      ft.isRightEdgePoint(e.getStartPoint()) &&
          ...
          (this.insertParagraph = this.wrapCommand(function () {
            ...
            (this.createLink = this.wrapCommand(function (t) {
              ...
              if (!(l > 0 && n.isLimited(l))) {
                ...
                n.setLastRange(
                  yt.create(h.node, h.offset, f.node, f.offset).select()
                );
              }
            })),
          ...
          (n = [
                ...
                return (
                  ...
                  (void 0 === e ||
                    !(
                      ...
                      e.ctrlKey ||
                      e.metaKey ||
                      x.contains([Ct.code.BACKSPACE, Ct.code.DELETE], e.keyCode)
                    )) &&
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  t.isOnAnchor() &&
                    (t = yt.createFromNode(ft.ancestor(t.sc, ft.isAnchor))),
                  t.toString()
                );
              },
            },
              ...
              value: function (t, e) {
                ...
                if ("" !== n) {
                  ...
                  if (
                    ...
                    r &&
                      !ft.nodeLength(r) &&
                      ((r.innerHTML = ft.ZERO_WIDTH_NBSP_CHAR),
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  (this.$codable.val(
                    ft.html(this.$editable, this.options.prettifyHtml)
                  ),
            ...
            },
            {
              ...
              value: function () {
                ...
                var e = this.purify(
                    ft.value(this.$codable, this.options.prettifyHtml) ||
                      ft.emptyPara
                  ),
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: "handleKeyup",
                value: function (t) {
                  x.contains([Ct.code.ENTER, Ct.code.SPACE], t.keyCode) &&
                    this.replace();
                },
              },
            ]) && Yt(e.prototype, n),
            ...
            },
            {
              ...
              value: function (t) {
                if (
                  ...
                  x.contains(this.keys, this.previousKeydownCode)
                )
                ...
                return (
                  Object.prototype.hasOwnProperty.call(
                    ...
                    (this.fontInstalledMap[t] =
                      v.isFontInstalled(t) ||
                      x.contains(this.options.fontNamesIgnoreCheck, t)),
                  this.fontInstalledMap[t]
                );
              },
            },
          ...
          (n = [
            {
              ...
              value: function () {
                return (
                  this.options.airMode && !x.isEmpty(this.options.popover.air)
                );
              },
            },
            {
          ...
          (n = [
              ...
              value: function () {
                ...
                if (t.length) {
                  ...
                  if (
                    ...
                    i()(e).after(o), yt.createFromNodeBefore(o).select();
            ...
            },
            {
              ...
              value: function (t, e) {
                var n = this,
                  o = i()(
                    '<div class="note-hint-group note-hint-group-' + t + '"/>'
                  );
                return (
