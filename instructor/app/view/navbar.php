      ...
      <ul class="navbar-nav mr-auto">
        <?php
          if($_SESSION['mydata']->isAdmin){ ?>
            ...
            <li class="nav-item <?php echo (isset($_GET['ViewFeedbackAdmin.php'])?'active':'') ?>">
              <a class="nav-link" href=\online-exam-system-master\ContactSupport\ViewFeedbackAdmin.php ">
                <i class="fa fa-group"></i>
        ...
        <li class="nav-item <?php echo (isset($_GET['Statistics'])?'active':'') ?>">
          <a class="nav-link" href="?Statistics">
            <i class="fa fa-bar-chart"></i>
            Statistics
          </a>
        </li>
        <li class="nav-item <?php echo (isset($_GET['feedback.php'])?'active':'') ?>">
              <a class="nav-link" href=" \online-exam-system-master\student\app\view\feedback.php">
                <i class="fa fa-group"></i>
                Feedback Of Quiz 
              </a>
            </li>
