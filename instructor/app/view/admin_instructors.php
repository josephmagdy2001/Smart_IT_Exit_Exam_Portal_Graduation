            ...
            <tbody>
                ...
                foreach ($instructors as $instructor) { ?>
                    <tr>
                        ...
                        <?php } ?>
                        <?php if($instructor->suspended){ ?>
                            <td>
                                <button type="button" class="btn btn-outline-danger btn-block"
                                        onclick="customConfirm('app/controller/admin.inc.php?removeInstructor=<?php echo $instructor->id ?>','Are you sure you want to remove This Instructor?','The Instructor has been removed.')">
